...
class SchoolStructure(models.Model):
    ...
    administrative_directorate_id = fields.Many2one('school.administrative_directorate', string='Administrative Directorate',
                                                    ...
                                                    ondelete="restrict")
    principal_id = fields.Many2one('hr.employee', string='Principal', translate=True, required=True,
                                  track_visibility='onchange', ondelete="restrict")
    assistant_director_id = fields.Many2one('hr.employee', string='Assistant Director', translate=True, required=True,
                                  track_visibility='onchange', ondelete="restrict")
    secret_keeper_id = fields.Many2one('hr.employee', string='Secret Keeper', translate=True, required=True,
                                  track_visibility='onchange', ondelete="restrict")
